...
contests = []
with open('C:\\Users\\jasplund\\Dropbox\\research\\gerry\\voting_data\\data\\2016\\z_election_data_all_2016.csv') as csvfile:
...
path =  'C:\\Users\\jasplund\\Dropbox\\research\\gerry\\voting_data\\data\\2016\\csv'
...
for file in filenames:
    ...
    with open('C:\\Users\\jasplund\\Dropbox\\research\\gerry\\voting_data\\data\\2016\\csv\\'+file) as csvfile:
        readFile = csv.reader(csvfile, delimiter=',')
        for row in readFile:
            if not 'Totals:'==row[0]:
                data1.append(row)
...
#            print(p[data1[0][0]])
#            print(totals1)
            p[data1[0][0]] = pd.concat([p[data1[0][0]],totals1], axis=0).drop_duplicates().reset_index(drop=True)
#            pass
...
#print(contest2)
#df_contest2 = pd.Series(contest2)
#print(df_contest2)
#path =  'C:\\Users\\jasplund\\Dropbox\\research\\gerry\\voting_data\\data\\2016\\csv'
#df_contest2.to_csv(path+'contest.csv',sep=',', encoding = 'utf-8')
